<template>
  <div id="services" class="main software">
    <div class="hero-section">
      <div class="container no-override">
        <div  id="main"  class="col-md-12">
          <img class="img-responsive wow fadeInDown" data-wow-delay="0.2s" src="../assets/img/peatio.png" alt="Hero Image" style="animation-delay: 0.2s; animation-name: fadeInDown;">
        </div>
        <div class="col-md-12">
    ...
    <div id="features" class="app-features text-center">
      <div class="container">
        <h1 class="wow fadeInDown" data-wow-delay="0.1s" style="animation-delay: 0.1s; animation-name: none;">Peatio Features and Details</h1>
